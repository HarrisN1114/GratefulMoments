...
struct StreakCalculator {
    ...
    ///
    ///Days are measured from the end of the day, rather than whatever time of day it currently is
    /// - precondition: 'moments' must be sorted by timestamp, from earlies to latest
